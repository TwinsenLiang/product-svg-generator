"""
Debug script to visualize contour detection
"""
import sys
import os
...
def main():
    ...
    try:
        ...
        if main_contour is not None:
            ...
            # Save the result
            cv2.imwrite("debug_contour_visualization.jpg", result_image)
            print("Contour visualization saved as debug_contour_visualization.jpg")
